...
/**
 * description: LIKELeft 表达式条件构建 '?%'
 *
 * @author zhouxinlei
 * @since 2024-01-29 14:57:41
 */
public class LIKELeftExpressionStrategy implements ExpressionStrategy {
    ...
    public Expression builderExpression(Table table, DataScopeConfProperties.DataColumn dataColumn) {
        ...
        if (StringUtils.isNotEmpty(val)) {
            ...
            likeExpression.setRightExpression(new StringValue(val.concat("%")));
